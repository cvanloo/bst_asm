...
test_avl_rebalance_left_right(Arena *arena) {
    ...
    TEST_ASSERT(is_tree_balanced(bst));
    Node *e23 = (Node *) bst_insert(bst, &keys[23], 0);
    TEST_ASSERT(e20->bf == 1);
    TEST_ASSERT(e23->bf == 0);
    TEST_ASSERT(is_tree_balanced(bst));
    Node *e17 = (Node *) bst_insert(bst, &keys[17], 0);
    TEST_ASSERT(e20->bf == 0);
    TEST_ASSERT(e23->bf == 0);
    TEST_ASSERT(e17->bf == 0);
    TEST_ASSERT(is_tree_balanced(bst));
    Node *e14 = (Node *) bst_insert(bst, &keys[14], 0);
    TEST_ASSERT(e20->bf == -1);
    TEST_ASSERT(e23->bf == 0);
    TEST_ASSERT(e17->bf == -1);
    TEST_ASSERT(e14->bf == 0);
    TEST_ASSERT(is_tree_balanced(bst));
    Node *e18 = (Node *) bst_insert(bst, &keys[18], 0);
    TEST_ASSERT(e20->bf == -1);
    TEST_ASSERT(e23->bf == 0);
    TEST_ASSERT(e17->bf == 0);
    TEST_ASSERT(e14->bf == 0);
    TEST_ASSERT(e18->bf == 0);
    TEST_ASSERT(is_tree_balanced(bst));
    Node *e19 = (Node *) bst_insert(bst, &keys[19], 0);
    TEST_ASSERT(bst->root == e18);
    TEST_ASSERT(bst->root->right == e20);
    TEST_ASSERT(e20->bf == 0);
    TEST_ASSERT(e23->bf == 0);
    TEST_ASSERT(e17->bf == -1);
    TEST_ASSERT(e14->bf == 0);
    TEST_ASSERT(e18->bf == 0);
    TEST_ASSERT(e19->bf == 0);
    TEST_ASSERT(is_tree_balanced(bst));
    return 1;
}
